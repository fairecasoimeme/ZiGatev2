...
namespace ZGWUI
{
    public partial class Form1 : Form
    {
        ...
        private void GUIinitialize()
        {
            ...
            MacAddressForLinkKeyTextBoxInit(ref textBoxMacAddressForLinkKey);
            InstallCodeForLinkKeyTextBoxInit(ref textBoxInstallCodesForLinkKey);
        ...
        private void MacAddressForLinkKeyTextBoxInit(ref TextBox textBox)
        {
            textBox.ForeColor = System.Drawing.Color.Gray;
            textBox.Text = "Address (64-bit Hex)";
        }

        private void InstallCodeForLinkKeyTextBoxInit(ref TextBox textBox)
        {
            textBox.ForeColor = System.Drawing.Color.Gray;
            textBox.Text = "Key (Format: Byte:Byte:Byte)";
            textBox.TextChanged += new EventHandler(textBoxInstallCodesForLinkKey_TextChanged);
        }
        ...
        *    }
        ...
        private void buttonSendInstallCodes_Click(object sender, EventArgs e)
        {
            string stringKeyData;
            UInt64 u64AddrData;

            if (bStringToUint64(textBoxMacAddressForLinkKey.Text, out u64AddrData) == true)
            {
                if (1 == (textBoxInstallCodesForLinkKey.TextLength % 2))
                {
                    stringKeyData = textBoxInstallCodesForLinkKey.Text;
                    sendInstallCodesData(u64AddrData, stringKeyData);
                }
            }
        }
        ...
        *    transmitCommand(0x0130, u8Len, commandData);
        ...
        private void sendInstallCodesData(UInt64 u64AddrData, string stringkeydata)
        {
            byte[] commandData = null;
            commandData = new byte[24];
            byte u8Len = 0;
        ...
        private void displayDecodedCommand(UInt16 u16Type, UInt16 u16Length, byte[] au8Data)
        {
            ...
            switch (u16Type)
            {
                ...
                case 0x802A:
                {
                    ...
                    richTextBoxMessageView.Text += " (Joining Information) ";
                    richTextBoxMessageView.Text += "\n";
                    richTextBoxMessageView.Text += "  Status: 0x" + au8Data[0].ToString("X2");
                    richTextBoxMessageView.Text += "\n";
                    richTextBoxMessageView.Text += "  Device Extended Address: " + u64AddrData.ToString("X8");
                    richTextBoxMessageView.Text += "\n";
                    richTextBoxMessageView.Text += " No install code available for this device";
                    richTextBoxMessageView.Text += "\n";
        ...
        #region Install Codes

        private void textBoxMacAddressForLinkKey_MouseHover(object sender, EventArgs e)
        {
            showToolTipWindow("Extended Address Data (64-bit Hex)");
        }

        private void textBoxMacAddressForLinkKey_MouseLeave(object sender, EventArgs e)
        {
            hideToolTipWindow();
        }

        private void textBoxInstallCodesForLinkKey_MouseHover(object sender, EventArgs e)
        {
            showToolTipWindow("Key (Format: Byte:Byte:Byte)");
        }

        private void textBoxInstallCodesForLinkKey_MouseLeave(object sender, EventArgs e)
        {
            hideToolTipWindow();
        }
        ...
        private void textBoxInstallCodesForLinkKey_TextChanged(object sender, EventArgs e)
        {
            if (textBoxInstallCodesForLinkKey.Text != "Key (Format: Byte:Byte:Byte)")
            {
                String rawData = "";
                int iRawDataSize;

                rawData = textBoxInstallCodesForLinkKey.Text;
                ...
                textBoxInstallCodesForLinkKey.Text = rawData;
                textBoxInstallCodesForLinkKey.SelectionStart = textBoxInstallCodesForLinkKey.Text.Length;
            }
        }
        ...
        private void textBoxMacAddressForLinkKey_MouseClick(object sender, MouseEventArgs e)
        {
            if (textBoxMacAddressForLinkKey.ForeColor != System.Drawing.Color.Black)
            {
                textBoxMacAddressForLinkKey.ForeColor = System.Drawing.Color.Black;
                textBoxMacAddressForLinkKey.Text = "";
            }
        }

        private void textBoxInstallCodesForLinkKey_MouseClick(object sender, MouseEventArgs e)
        {
            if (textBoxInstallCodesForLinkKey.ForeColor != System.Drawing.Color.Black)
            {
                textBoxInstallCodesForLinkKey.ForeColor = System.Drawing.Color.Black;
                textBoxInstallCodesForLinkKey.Text = "";
            }
        ...
        private void textBoxMacAddressForLinkKey_Leave(object sender, EventArgs e)
        {
            if (string.IsNullOrWhiteSpace(textBoxMacAddressForLinkKey.Text))
            {
                textBoxMacAddressForLinkKey.ForeColor = System.Drawing.Color.Gray;
                textBoxMacAddressForLinkKey.Text = "Address (64-bit Hex)";
            }
        }

        private void textBoxInstallCodesForLinkKey_Leave(object sender, EventArgs e)
        {
            if (string.IsNullOrWhiteSpace(textBoxInstallCodesForLinkKey.Text))
            {
                textBoxInstallCodesForLinkKey.ForeColor = System.Drawing.Color.Gray;
                textBoxInstallCodesForLinkKey.Text = "Key (Format: Byte:Byte:Byte)";
            }
        }
