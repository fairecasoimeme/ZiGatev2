...
- pin_list:
  ...
  - {pin_num: '11', peripheral: USART0, signal: TXD, pin_signal: PIO0_8/SPI0_MOSI/USART0_TXD/CT32B0_MAT0/PWM8_PU/ANA_COMP_OUT/RFTX/PDM1_DATA, mode: pullUp, slew0: disabled,
    invert: disabled, filter_off: disabled, slew1: disabled, open_drain: disabled, ssel: disabled}
  - {pin_num: '5', peripheral: SPI0, signal: SCK, pin_signal: PIO0_2/SPI0_SCK/USART0_RXD/PWM2_PD/SPI1_MOSI/ISO7816_RST/MCLK, mode: pullDown, slew0: disabled, invert: disabled,
    filter_off: disabled, slew1: disabled, open_drain: disabled, ssel: disabled}
  - {pin_num: '6', peripheral: SPI0, signal: MISO, pin_signal: PIO0_3/SPI0_MISO/USART0_TXD/PWM3_PU/SPI1_SSELN0/ISO7816_CLK, mode: pullUp, slew0: disabled, invert: disabled,
    filter_off: disabled, slew1: disabled, open_drain: disabled, ssel: disabled}
  - {pin_num: '7', peripheral: SPI0, signal: MOSI, pin_signal: PIO0_4/SPI0_MOSI/USART0_CTS/PWM4_PU/SPI1_SSELN1/ISO7816_IO/RFTX, mode: pullUp, slew0: disabled, invert: disabled,
    filter_off: disabled, slew1: disabled, open_drain: disabled, ssel: disabled}
  - {pin_num: '8', peripheral: SPI0, signal: SSELN, pin_signal: PIO0_5/SPI0_SSELN/USART0_RTS/SPI1_MISO/SPI1_SSELN2/RFRX, mode: pullUp, slew0: disabled, invert: disabled,
    filter_off: disabled, slew1: disabled, open_drain: disabled, ssel: disabled}
  - {pin_num: '22', peripheral: SPI1, signal: MISO, pin_signal: PIO0_18/SPI1_MISO/ISO7816_IO/CT32B0_MAT1/PWM7_PD/USART0_TXD/SPIFI_CLK, mode: pullDown, slew0: disabled,
    invert: disabled, filter_off: disabled, slew1: disabled, open_drain: disabled, ssel: disabled}
  - {pin_num: '19', peripheral: SPI1, signal: SSELN0, pin_signal: PIO0_16/SPI1_SSELN0/ISO7816_RST/PWM5_PU/I2C0_SDA/PDM1_CLK/SPIFI_CSN, mode: pullUp, slew0: disabled,
    invert: disabled, filter_off: disabled, slew1: disabled, open_drain: disabled, ssel: disabled}
  - {pin_num: '18', peripheral: SPI1, signal: SCK, pin_signal: PIO0_15/SPI1_SCK/ANA_COMP_OUT/PWM3_PU/I2C0_SCL/PDM1_DATA/RFRX, mode: pullUp, slew0: disabled, invert: disabled,
    filter_off: disabled, slew1: disabled, open_drain: disabled, ssel: disabled}
  - {pin_num: '21', peripheral: SPI1, signal: MOSI, pin_signal: PIO0_17/SPI1_MOSI/ISO7816_CLK/SWO/PWM6_PD/CLK_OUT/SPIFI_IO3, mode: pullDown, slew0: disabled, invert: disabled,
    filter_off: disabled, slew1: disabled, open_drain: disabled, ssel: disabled}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port0_pin16_config = (/* Pin is configured as SPI1_SSELN0 */
                                         IOCON_PIO_FUNC1 |
                                         /* Selects pull-up function */
                                         IOCON_PIO_MODE_PULLUP |
                                         /* Standard mode, output slew rate control is disabled */
                                         ...
                                         /* SSEL is disabled */
                                         IOCON_PIO_SSEL_DI);
    /* PORT0 PIN16 (coords: 19) is configured as SPI1_SSELN0 */
    ...
    const uint32_t port0_pin18_config = (/* Pin is configured as SPI1_MISO */
                                         IOCON_PIO_FUNC1 |
                                         /* Selects pull-down function */
                                         IOCON_PIO_MODE_PULLDOWN |
                                         /* Standard mode, output slew rate control is disabled */
                                         ...
                                         /* SSEL is disabled */
                                         IOCON_PIO_SSEL_DI);
    /* PORT0 PIN18 (coords: 22) is configured as SPI1_MISO */
    ...
    const uint32_t port0_pin3_config = (/* Pin is configured as SPI0_MISO */
                                        IOCON_PIO_FUNC1 |
                                        /* Selects pull-up function */
                                        IOCON_PIO_MODE_PULLUP |
                                        /* Standard mode, output slew rate control is disabled */
                                        ...
                                        /* SSEL is disabled */
                                        IOCON_PIO_SSEL_DI);
    /* PORT0 PIN3 (coords: 6) is configured as SPI0_MISO */
