...
#ifdef JN5189DK6
#ifdef OM15082
/* JN5189DK6 with OM15082 shield */
/* configuration mode - leds/state*/
const appLedsConfig_t gLedCfgFactoryDefault =        {LedCfg_Flashing(LED1),        LedCfg_Flashing(LED2),            LedCfg_Flashing(LED3)};
const appLedsConfig_t gLedCfgJoiningOrAttaching =    {LedCfg_Chasing(LED1),         LedCfg_Chasing(LED2),             LedCfg_Chasing(LED3)};
const appLedsConfig_t gLedCfgNwkConnected =          {LedCfg_Off(LED1),             LedCfg_Off(LED2),                 LedCfg_Off(LED3)};
const appLedsConfig_t gLedCfgNwkOperationPending =   {LedCfg_Off(LED1),             LedCfg_Off(LED2),                 LedCfg_Off(LED3)};
#if !OT_ED_CONFIG
const appLedsConfig_t gLedCfgIsLeader =              {LedCfg_On(LED1),              LedCfg_On(LED2),                 LedCfg_Off(LED3)};
const appLedsConfig_t gLedCfgIsActiveRouter =        {LedCfg_Off(LED1),             LedCfg_On(LED2),                 LedCfg_Off(LED3)};
#endif
/* application mode - leds/state*/
const appLedsConfig_t gLedCfgAppLedOn =            {LedCfg_NotUsed(LED1),         LedCfg_NotUsed(LED2),             LedCfg_On(LED3)};
const appLedsConfig_t gLedCfgAppLedOff =           {LedCfg_NotUsed(LED1),         LedCfg_NotUsed(LED2),             LedCfg_Off(LED3)};
const appLedsConfig_t gLedCfgAppLedToggle =        {LedCfg_NotUsed(LED1),         LedCfg_NotUsed(LED2),             LedCfg_Toggle(LED3, gLedState_Undefined_c)};
const appLedsConfig_t gLedCfgAppLedFlash =         {LedCfg_NotUsed(LED1),         LedCfg_NotUsed(LED2),             LedCfg_Flashing(LED3)};
#else
/* JN5189DK6 without OM15082 shield */
/* configuration mode - leds/state*/
...
const appLedsConfig_t gLedCfgNwkOperationPending =   {LedCfg_Off(LED1),             LedCfg_Off(LED2)};
#if !OT_ED_CONFIG
const appLedsConfig_t gLedCfgIsLeader =              {LedCfg_On(LED1),              LedCfg_On(LED2)};
const appLedsConfig_t gLedCfgIsActiveRouter =        {LedCfg_Off(LED1),             LedCfg_On(LED2)};
#endif
/* application mode - leds/state*/
const appLedsConfig_t gLedCfgAppLedOn =            {LedCfg_NotUsed(LED1),         LedCfg_NotUsed(LED2)};
const appLedsConfig_t gLedCfgAppLedOff =           {LedCfg_NotUsed(LED1),         LedCfg_NotUsed(LED2)};
const appLedsConfig_t gLedCfgAppLedToggle =        {LedCfg_NotUsed(LED1),         LedCfg_NotUsed(LED2)};
const appLedsConfig_t gLedCfgAppLedFlash =         {LedCfg_NotUsed(LED1),         LedCfg_NotUsed(LED2)};
#endif /* OM15082 */
#endif /* JN5189DK6 */
