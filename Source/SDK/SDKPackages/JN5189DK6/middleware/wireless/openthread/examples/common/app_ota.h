...
\return   otaStatus_t
 ***************************************************************************************************/
otaStatus_t OtaServerInit(void);
...
\return   otaStatus_t
 ***************************************************************************************************/
otaStatus_t OtaClientInit(otInstance *pOtInstance);
...
\return   otaStatus_t
 ***************************************************************************************************/
otaStatus_t OtaClient_StartServerDiscovery(void);
...
void OtaClient_CoapCb(void *pCtx, otMessage *pMsg, const otMessageInfo *pMsgInfo);

/* OTA Server Coap callback */
void OtaServer_CoapCb(void *pCtx, otMessage *pMsg, const otMessageInfo *pMsgInfo);
