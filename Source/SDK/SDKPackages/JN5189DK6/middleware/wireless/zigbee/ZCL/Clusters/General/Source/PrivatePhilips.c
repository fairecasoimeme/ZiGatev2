...
/***        Local Variables                                               ***/
/****************************************************************************/
uAttribData uAttributeValPhilips;
					...
					tsZCL_ClusterInstance       *psClusterInstance)
{
	...
	while(u16payloadSize-u16inputOffset > 0)
	{
		...
		uAttributeValPhilips.sStrData.u8Length = (uint8 )u16stringDataLength;
		uAttributeValPhilips.sStrData.pu8Data = pu8stringData;
		sZCL_CallBackEvent.uMessage.sIndividualAttributeResponse.pvAttributeData = (void *)&uAttributeValPhilips;
...
/****************************************************************************
 *
 * NAME:       eCLD_PrivatePhilipsCreate
 *
 * DESCRIPTION:
 * Creates a private Philips cluster
 *
